...
def choice_to_number(string1):
    return {'Usain':1,'Me':2,'Qazi':3}[string1]
        
def number_to_choice(num1):
    return {1:'Usain',2:'Me',3:'Qazi'}[num1]
